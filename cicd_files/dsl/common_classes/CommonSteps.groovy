...
class CommonSteps {
    ...
    static String defaultJobDescription(String jobName, String jobDescription, String groovyFilePath, String jenkinsFilePath, String rulesetFilePath=null) {
        ...
        if (rulesetFilePath != null) {
            rulesetFilePathString = "<p><b>Ruleset file location:</b> <a href='https://gerrit-gamma.gic.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci/pooling-tooling/+/master/${rulesetFilePath}'>${rulesetFilePath}</a></p>"
        }
        return """
            ...
            <p><b>Repository:</b> <a href="https://gerrit-gamma.gic.ericsson.se/#/q/project:OSS/com.ericsson.oss.ci/pooling-tooling">OSS/com.ericsson.oss.ci/pooling-tooling</a></p>
            <p><b>Groovy file location:</b> <a href='https://gerrit-gamma.gic.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci/pooling-tooling/+/master/${groovyFilePath}'>${groovyFilePath}</a></p>
            <p><b>Jenkinsfile location:</b> <a href='https://gerrit-gamma.gic.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci/pooling-tooling/+/master/${jenkinsFilePath}'>${jenkinsFilePath}</a></p>
