...
def pipelineBeingGeneratedName = 'resource-pooling-tool_Pipeline_Generator'

pipelineJob(pipelineBeingGeneratedName) {
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName,
        "The ${pipelineBeingGeneratedName} job is used to generate initial RPT CICD pipelines and a CICD pipeline updater job",
