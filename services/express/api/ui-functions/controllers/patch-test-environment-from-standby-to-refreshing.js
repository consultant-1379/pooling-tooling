...
function makePatchTestEnvironmentFromStandbyToRefreshing(
  dbOperator,
  ...
  return async function patchTestEnvironmentFromStandbyToRefreshing(httpRequest) {
    ...
    const loggingTags = {
      ...
      action: 'patchTestEnvironmentFromStandbyToRefreshing',
      actionParameters: {},
    };
    ...
    logger.info(loggingTags, `PATCH request to update Test Environment object status from Standby to Refreshing \
...
module.exports = { makePatchTestEnvironmentFromStandbyToRefreshing };
