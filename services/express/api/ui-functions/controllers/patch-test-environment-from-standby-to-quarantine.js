...
function makePatchTestEnvironmentFromStandbyToQuarantine(
  dbOperator,
  ...
  return async function patchTestEnvironmentFromStandbyToQuarantine(httpRequest) {
    ...
    const loggingTags = {
      ...
      action: 'patchTestEnvironmentFromStandbyToQuarantine',
      actionParameters: {},
    };
    ...
    logger.info(loggingTags, `PATCH request to update Test Environment object status from Standby to Quarantine \
...
module.exports = { makePatchTestEnvironmentFromStandbyToQuarantine };
