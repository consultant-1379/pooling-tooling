...
function makePatchTestEnvironmentFromQuarantinedToReserved(
  dbOperator,
  ...
  return async function patchTestEnvironmentFromQuarantinedToReserved(httpRequest) {
    ...
    const loggingTags = {
      ...
      action: 'patchTestEnvironmentFromQuarantinedToReserved',
      actionParameters: {},
    };
    ...
    logger.info(loggingTags, `PATCH request to update Test Environment object status from Quarantine to Reserved \
...
module.exports = { makePatchTestEnvironmentFromQuarantinedToReserved };
