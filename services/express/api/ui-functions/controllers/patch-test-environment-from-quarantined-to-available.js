...
function makePatchTestEnvironmentFromQuarantinedToAvailable(
  dbOperator,
  ...
  return async function patchTestEnvironmentFromQuarantinedToAvailable(httpRequest) {
    ...
    const loggingTags = {
      ...
      action: 'patchTestEnvironmentFromQuarantinedToAvailable',
      actionParameters: {},
    };
    ...
    logger.info(loggingTags, `PATCH request to update Test Environment object status from Quarantine to Available \
...
module.exports = { makePatchTestEnvironmentFromQuarantinedToAvailable };
