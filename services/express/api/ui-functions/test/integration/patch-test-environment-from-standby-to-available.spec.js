...
describe('Integration Test: (UI Functions service) Testing patch controller to update the Test Environment (Standby -> Available) and/or Request', () => {
  beforeEach(async () => {
  ...
  it('should return updatedTestEnvironment only.', async () => {
    ...
    const testEnvironmentChanges = await patchTestEnvironmentFromStandbyToAvailable(testHttpRequest);
