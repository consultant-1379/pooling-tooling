...
const { makePatchTestEnvironmentFromQuarantinedToReserved } = require('../../controllers/patch-test-environment-from-quarantined-to-reserved');
...
describe('Integration Test: (UI Functions service) Testing patch controller to update the Test Environment (Quarantine -> Reserved) and/or Request', () => {
  beforeEach(async () => {
  ...
  it('should return updatedTestEnvironment only.', async () => {
    ...
    expect(testEnvironmentFromDbBeforePatching.status).toEqual('Quarantine');
    ...
    const testEnvironmentChanges = await patchTestEnvironmentFromQuarantinedToReserved(testHttpRequest);
  ...
  it('should throw an error if the test environment is undefined or object is empty.', async () => {
    ...
    await patchTestEnvironmentFromQuarantinedToReserved(testHttpRequest).catch((error) => {
  ...
  it('should throw an \'Invalid http request to update Test Environment and/or Request entity.\'', async () => {
    const fakeTestEnvironment = makeFakeTestEnvironment({ status: 'Quarantine' });
    await dbOperator.insert(fakeTestEnvironment, 'testEnvironments');
