...
describe('Integration Test: (UI Functions service) Testing patch controller to update the Test Environment (Standby -> Quarantine) and/or Request', () => {
  beforeEach(async () => {
  ...
  it('should return updatedTestEnvironment only.', async () => {
    ...
    const testEnvironmentChanges = await patchTestEnvironmentFromStandbyToQuarantine(testHttpRequest);
  ...
  it('should throw an error if the test environment is undefined or object is empty.', async () => {
    ...
    await patchTestEnvironmentFromStandbyToQuarantine(testHttpRequest).catch((error) => {
