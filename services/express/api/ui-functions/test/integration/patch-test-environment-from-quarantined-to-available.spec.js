...
describe('Integration Test: (UI Functions service) Testing patch controller to update the Test Environment (Quarantine -> Available) and/or Request', () => {
  beforeEach(async () => {
  ...
  it('should return updatedTestEnvironment only.', async () => {
    ...
    const testEnvironmentChanges = await patchTestEnvironmentFromQuarantinedToAvailable(testHttpRequest);
    expect(testEnvironmentChanges.requestId).toEqual('');
    expect(testEnvironmentChanges.status).toEqual('Available');
    expect(testEnvironmentChanges.additionalInfo).toEqual('userId: \'TESTING_ID\'');
    expect(testEnvironmentChanges.stage).toEqual('');
  ...
  it('should throw an error if the test environment is undefined or object is empty.', async () => {
    ...
    await patchTestEnvironmentFromQuarantinedToAvailable(testHttpRequest).catch((error) => {
